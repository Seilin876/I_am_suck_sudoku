...
public class PlayPad_m {
    ...
    private String[][] make_board_m(int m) {
        String[][] board = null;
        int n = m * m;
...
// 打亂順序
    ...
    public void print_board(String[][] board, int m,Graphics g) {
        int n = m * m;
        int hard =12;
    ...
    public void num(Graphics g) {
        ...
        jp = new JPanel();
        PlayPad_m s = new PlayPad_m();
        int m = 3,i=5,j=5;
        String[][] b = s.make_board_m(m);
        for (int z = 0; z < 9; z++ ) {
